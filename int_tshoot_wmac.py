...
parser.add_argument("-mac", "--mac_add", help="Enter at minimum the endpoints last four MAC-Address characters in format xxxx.xxxx.xxxx or xxxx")
args = parser.parse_args()

# Create objects from arguments collected when running script.
device_ip = args.router_ip
macaddr = args.mac_add
